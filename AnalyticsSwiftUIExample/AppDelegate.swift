...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        let analyticsServiceConfiguration:AnalyticsServiceConfiguration
        
        switch appNetworkEnvironment {
        case .local:
            analyticsServiceConfiguration = AnalyticsServiceConfiguration.defaultLocalConfiguration
        case .stage:
            analyticsServiceConfiguration = AnalyticsServiceConfiguration(
                environment: .stage,
                scheme: appNetworkEnvironment.scheme,
                host: appNetworkEnvironment.host,
                port: appNetworkEnvironment.port,
    ...
    func applicationDidReceiveMemoryWarning(_ application: UIApplication) {
        AnalyticsService.shared().applicationDidReceiveMemoryWarning( application )
    }
...
//        */
//        let container = NSPersistentCloudKitContainer(name: "YackPersistantName")
